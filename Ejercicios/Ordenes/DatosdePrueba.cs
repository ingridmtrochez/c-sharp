...
private void cargarClientes()
{
    ...
    Cliente c2 = new Cliente (2,"Sandra","99999");
...
private void cargarProductos()
    ...
    {   
        ...
        while(true)
        {
            ...
            Console.ReadLine();
                ...
                Console.WriteLine("* Producto agregado: " + producto.Descripcion + " -> con precio de: " + producto.Precio + " lps *");
        ...
        Console.WriteLine("Impuesto del 15%: " + nuevaOrden.Impuesto);
        Console.WriteLine("Total de la orden es de: " + nuevaOrden.Total + " Lps");
        Console.ReadLine();
    }
    ...
    public void ListarOrdenes()
    {
        ...
        {
            Console.WriteLine(orden.Codigo + " | " + orden.Fecha + " | " + orden.SubTotal + " | " + orden.Impuesto+ " | " + orden.Total + " Lps");
            Console.WriteLine(orden.Cliente.Nombre + " | " + orden.Vendedor.Nombre);
            Console.WriteLine("");
            Console.WriteLine("Detalle del producto");
            Console.WriteLine("");
            Console.WriteLine("Descrip|Cant|Precio");
